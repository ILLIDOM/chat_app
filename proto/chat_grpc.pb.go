...
func (c *chatClient) JoinChannel(ctx context.Context, in *Channel, opts ...grpc.CallOption) (Chat_JoinChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &Chat_ServiceDesc.Streams[0], "/proto.Chat/JoinChannel", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *chatClient) SendMessage(ctx context.Context, opts ...grpc.CallOption) (Chat_SendMessageClient, error) {
	stream, err := c.cc.NewStream(ctx, &Chat_ServiceDesc.Streams[1], "/proto.Chat/SendMessage", opts...)
	if err != nil {
		return nil, err
	}
